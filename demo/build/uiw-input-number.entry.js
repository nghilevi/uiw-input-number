...
const uiwInputNumberCss = ".uiw-input-number__header{display:flex;flex-flow:row;justify-content:space-between;margin-bottom:4px;font-size:0.875rem;line-height:1.25rem;font-weight:400}.uiw-input-number--error .uiw-input-number__header__label{color:#e70404}.uiw-input-number__header__optional-label{color:#5a575c}.uiw-input-number__field-container{align-items:center;display:flex;padding:4px 0}.uiw-input-number__field-container__button{align-items:center;background:transparent;border:1px solid #00005e;box-shadow:0 0 0 2px transparent;color:#00005e;cursor:pointer;display:inline-flex;flex:0 0 auto;height:32px;justify-content:center;margin:0;outline:0;padding:0;transition:background-color 400ms cubic-bezier(0.075, 0.82, 0.165, 1), box-shadow 400ms cubic-bezier(0.075, 0.82, 0.165, 1);width:32px}.uiw-input-number__field-container__button:focus{box-shadow:0 0 0 2px #aed5ff}@media (hover: hover) and (pointer: fine){.uiw-input-number__field-container__button:hover{background-color:#dcedff}}.uiw-input-number__field-container__button:disabled{background-color:transparent;box-shadow:0 0 0 4px transparent;border-color:#c9c7c7;color:#c9c7c7;pointer-events:none}.uiw-input-number__field-container__input{background-color:transparent;border:0;flex:0 1 auto;font-family:inherit;min-width:0;padding:0 12px;outline:0;text-align:center;-webkit-appearance:none;width:var(--uiwInputNumberInputWidth);font-size:1.125rem;line-height:1.625rem;font-weight:600;-moz-appearance:textfield}.uiw-input-number__field-container__input::-ms-clear{display:none}.uiw-input-number__field-container__input::-webkit-outer-spin-button,.uiw-input-number__field-container__input::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.uiw-input-number__field-container__input::placeholder{color:#5a575c}.uiw-input-number__field-container__input:disabled{color:#8b8a8d;pointer-events:none}.uiw-input-number__footer{display:flex;flex-flow:column;font-size:0.875rem;line-height:1.25rem;font-weight:400}.uiw-input-number__footer__hint{margin-top:4px;color:#5a575c}.uiw-input-number__footer__error{align-items:center;color:#e70404;display:flex;margin-top:4px}.uiw-input-number__footer__error__icon{margin-right:8px}@media (prefers-color-scheme: dark){.uiw-enable-dark-mode .uiw-input-number__header__label{color:white}.uiw-enable-dark-mode .uiw-input-number--error .uiw-input-number__header__label{color:#fc6161}.uiw-enable-dark-mode .uiw-input-number__header__optional-label{color:#c9c7c7}.uiw-enable-dark-mode .uiw-input-number__field-container__button{color:#83b8ed;border-color:#83b8ed}.uiw-enable-dark-mode .uiw-input-number__field-container__button:focus{box-shadow:0 0 0 2px #dcedff}}@media (prefers-color-scheme: dark) and (hover: hover) and (pointer: fine){.uiw-enable-dark-mode .uiw-input-number__field-container__button:hover{background-color:#383838}}@media (prefers-color-scheme: dark){.uiw-enable-dark-mode .uiw-input-number__field-container__button:disabled{background-color:transparent;border-color:#5a575c;box-shadow:0 0 0 4px transparent;color:#5a575c}}@media (prefers-color-scheme: dark){.uiw-enable-dark-mode .uiw-input-number__field-container__input{color:white}.uiw-enable-dark-mode .uiw-input-number__field-container__input:disabled{color:#5a575c}}@media (prefers-color-scheme: dark){.uiw-enable-dark-mode .uiw-input-number__footer__error{color:#fc6161}}@media (prefers-color-scheme: dark){.uiw-enable-dark-mode .uiw-input-number__footer__hint{color:#c9c7c7}}.uiw-enforce-dark-mode .uiw-input-number__header__label{color:white}.uiw-enforce-dark-mode .uiw-input-number--error .uiw-input-number__header__label{color:#fc6161}.uiw-enforce-dark-mode .uiw-input-number__header__optional-label{color:#c9c7c7}.uiw-enforce-dark-mode .uiw-input-number__field-container__button{color:#83b8ed;border-color:#83b8ed}.uiw-enforce-dark-mode .uiw-input-number__field-container__button:focus{box-shadow:0 0 0 2px #dcedff}@media (hover: hover) and (pointer: fine){.uiw-enforce-dark-mode .uiw-input-number__field-container__button:hover{background-color:#383838}}.uiw-enforce-dark-mode .uiw-input-number__field-container__button:disabled{background-color:transparent;border-color:#5a575c;box-shadow:0 0 0 4px transparent;color:#5a575c}.uiw-enforce-dark-mode .uiw-input-number__field-container__input{color:white}.uiw-enforce-dark-mode .uiw-input-number__field-container__input:disabled{color:#5a575c}.uiw-enforce-dark-mode .uiw-input-number__footer__error{color:#fc6161}.uiw-enforce-dark-mode .uiw-input-number__footer__hint{color:#c9c7c7}";
...
let UiwInputNumber = class {
  ...
  updateInputWidth(value) {
    ...
    this.inputElementRef.style.setProperty('--uiwInputNumberInputWidth', `${valueLength}ch`);
  }
